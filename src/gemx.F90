...
!      use para_com
      ...
      subroutine gradz_c(u_c, uz_c, Rgrid_c) bind(c, name = 'gradz_c_')
         use iso_c_binding
         real(c_double) :: u_c(0:imx,0:jmx,0:kmx), uz_c(0:imx,0:jmx,0:kmx), Rgrid_c(0:nx)
      end subroutine gradz_c

      subroutine fluxavg_c(i3D, phi_in, phiavg_in) bind(c, name = 'fluxavg_c_')
         use iso_c_binding
         integer(c_int) :: i3D
         real(c_double) :: phi_in(0:imx, 0:jmx, 0:kmx), phiavg_in(0:nx, 0:nz)
      end subroutine fluxavg_c

      subroutine efieldcalc_c(Rgrid, Zgrid, input_phi) bind(c, name = 'efieldcalc_c_')
         use iso_c_binding
         real(c_double) :: Rgrid(0:nx), Zgrid(0:nz), input_phi(0:imx, 0:jmx, 0:kmx)
      ...
      subroutine boltzsolve_c(phi, i3D, c2_over_vA2, OPPphi, OPPphik) bind(c, name = 'BoltzSolve_c_')
         use iso_c_binding
         integer(c_int) :: i3D
         real(c_double) :: phi(0:imx, 0:jmx, 0:kmx), OPPphi(0:imx, 0:jmx, 0:kmx), OPPphik(0:imx, 0:jmx, 0:kmx)
         real(c_double) :: c2_over_vA2(0:nx, 0:nz)
      ...
      subroutine get_jpar_c(matrix, Rgrid) bind(c, name = 'get_jpar_c_')
         use iso_c_binding
         real(c_double) :: matrix(0:imx, 0:jmx, 0:kmx), Rgrid(0:nx)
      end subroutine get_jpar_c

      subroutine integ_c(iflag, i3D) bind(c, name = 'integ_c_')
         use iso_c_binding
         integer(c_int) iflag, i3D
      end subroutine integ_c
      
      subroutine grid1_c(ip, n, MyId) bind(c, name = 'grid1_c_')
         use iso_c_binding
         integer(c_int) ip, n, MyId
